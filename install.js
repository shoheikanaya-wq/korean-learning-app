(() => {
  ...
  if('serviceWorker'in navigator)navigator.serviceWorker.register('./sw.js?v=312970',{updateViaCache:'none'}).catch(()=>{$('status').textContent='アプリの準備に失敗しました。通信を確認してページを開き直してください。';});
})();
